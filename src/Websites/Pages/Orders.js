...
function Orders() {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/unfulfilledorders", {
      method: "POST",
      headers: {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/fulfilledorders", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
                ...
                <td>
                  <button
                    onClick={() =>
                      axios
                        .post(
                          `http://localhost:5000/orderchangefulfilledY2N`,
                          {
                            item,
                          }
                        )
                ...
                <td>
                  <button
                    onClick={() =>
                      axios
                        .post(
                          `http://localhost:5000/orderchangefulfilledN2Y`,
                          {
                            item,
                          }
                        )
