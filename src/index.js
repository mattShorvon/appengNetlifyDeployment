...
class MasterForm extends React.Component {
  ...
  async checkEmailAvailability() {
    ...
    const data = await axios.get("http://comp0067.herokuapp.com/api/users/checkmail", { params: datapoint });
  ...
  async checkBusinessNameAvailability() {
    ...
    const data = await axios.get("http://comp0067.herokuapp.com/api/users/checkbusiness", { params: datapoint });
    console.log(data)
  ...
  Register = () => {
    ...
    axios.post('http://comp0067.herokuapp.com/api/users/Register', userData)
        .then((response) => {
